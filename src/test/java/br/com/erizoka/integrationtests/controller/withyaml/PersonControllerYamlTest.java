...
import br.com.erizoka.integrationtests.vo.PersonVO;
import br.com.erizoka.integrationtests.vo.TokenVO;
import br.com.erizoka.integrationtests.vo.pagedmodels.PagedModelPerson;
...
public class PersonControllerYamlTest extends AbstractIntegrationTest{
	...
	public void testDisablePersonById() throws JsonMappingException, JsonProcessingException {
		...
		var persistedPerson = given().spec(specification)
				...
				.contentType(TestConfigs.CONTENT_TYPE_YML)
				.accept(TestConfigs.CONTENT_TYPE_YML)
					.header(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_ERIZOKA)
