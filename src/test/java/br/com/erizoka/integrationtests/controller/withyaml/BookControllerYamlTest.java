package br.com.erizoka.integrationtests.controller.withyaml;
...
import br.com.erizoka.configs.TestConfigs;
import br.com.erizoka.integrationtests.controller.withyaml.mapper.YMLMapper;
import br.com.erizoka.integrationtests.testcontainers.AbstractIntegrationTest;
import br.com.erizoka.integrationtests.vo.AccountCredentialsVO;
import br.com.erizoka.integrationtests.vo.BookVO;
import br.com.erizoka.integrationtests.vo.TokenVO;
import br.com.erizoka.integrationtests.vo.pagedmodels.PagedModelBook;
...
public class BookControllerYamlTest extends AbstractIntegrationTest {
    ...
    public void testFindAll() throws JsonMappingException, JsonProcessingException {
        ...
        BookVO foundBookSeven = content.get(4);
        ...
        assertEquals(110.00, foundBookSeven.getPrice());
        
        BookVO foundBookNine = content.get(1);
        
        assertNotNull(foundBookNine.getId());
        assertNotNull(foundBookNine.getTitle());
        assertNotNull(foundBookNine.getAuthor());
        assertNotNull(foundBookNine.getPrice());
        assertTrue(foundBookNine.getId() > 0);
        assertEquals("Java Concurrency in Practice", foundBookNine.getTitle());
        assertEquals("Brian Goetz e Tim Peierls", foundBookNine.getAuthor());
        assertEquals(80.00, foundBookNine.getPrice());
    }
