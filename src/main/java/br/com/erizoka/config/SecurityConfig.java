...
import br.com.erizoka.security.jwt.JwtTokenFilter;
import br.com.erizoka.security.jwt.JwtTokenProvider;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        Filter customFilter = new JwtTokenFilter(tokenProvider);
        return http
